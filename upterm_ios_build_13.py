...
def run_upterm_test():
    ...
    try:
        ...
        # We need pty for upterm, but let's try a single line command injection
...
"""
        ...
        # Inject script
        shell.send(f"echo '{b64}' | base64 -d > /tmp/build_ipa.sh && bash /tmp/build_ipa.sh && echo 'DONE_IPA'\r")
