...
from actool_linux.core.carwriter import (
...
from actool_linux.assets.atlas import packed_atlas_renditions, packed_watch_complication_renditions
from actool_linux.assets.imagestack import StackLayerImage, imagestack_renditions
from actool_linux.tools.model import Asset, Catalog, Diagnostic, load_catalog
from actool_linux.assets.appicons import app_icon_entry_rank, app_icon_sidecar_specs
...
def compile_catalogs(inputs: list[Path], options: CompileOptions) -> CompileResult:
    ...
    from actool_linux.core import carwriter as _cw
