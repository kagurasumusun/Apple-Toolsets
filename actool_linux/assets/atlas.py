...
from actool_linux.core.carwriter import AssetRendition, _csi_png_deepmap, _fixed, _identifier, build_assets_car
...
def packed_atlas_renditions(
    ...
    *,
    ...
    from actool_linux.core.carwriter import _decode_png_8bit
    if not images:
