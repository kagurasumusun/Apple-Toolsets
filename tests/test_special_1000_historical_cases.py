...
from actool_linux.core.carwriter import build_assets_car, png_rendition, _identifier, _localization_identifier, AssetRendition, _csi_png_palette_img
...
def palette_png_rendition_helper(name: str, data: bytes, *, scale: int = 1, appearance: int = 0) -> AssetRendition:
    from actool_linux.core.carwriter import _csi_png_palette_img
