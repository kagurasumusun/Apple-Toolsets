...
from actool_linux.core.carwriter import build_assets_car, png_rendition, _car_header
from actool_linux.core.coreui import (
...
class CoreUIProfileTests(unittest.TestCase):
    ...
    def test_auto_select_profile(self):
        from actool_linux.core.coreui import auto_select_profile, COREUI_700, COREUI_850, COREUI_918_MACOS
    ...
    def test_unknown_appearance_rejected(self):
        from actool_linux.core.carwriter import AssetRendition
