...
from actool_linux.assets.texture import build_texture_auxiliary_flag, build_texture_reference_payload, parse_texture_auxiliary_flag, parse_texture_reference_payload
