...
required=['SESSION_HANDOFF_COMPLETE.md','HANDOFF.md','ENGINEERING_LOG.md','PROJECT_STATE.json','VERIFICATION.md','EVIDENCE_MANIFEST.json']
errors=[]
...
for name in ('PROJECT_STATE.json','diagnostic-schema3.json','runtime-consumer-matrix-verified.json'):
 path=ROOT/name
 if path.is_file():
