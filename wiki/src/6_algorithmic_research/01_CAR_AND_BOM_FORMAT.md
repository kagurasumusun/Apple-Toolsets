...
| :--- | :--- | :--- | :--- |
| `0..8` | `char[8]` | `magic` | 必ず `b"BOMStore"` (ASCII 8 bytes) |
...
| `20..148` | `char[128]` | `main_version` | コンパイラ識別文字列（例: `"actool 0.1.0"`） |
...
*This specification represents the 100% complete, bit-exact binary standard enforced by `apple-toolsets`.*
